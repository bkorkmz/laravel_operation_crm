...
<head>
    ...
    <link rel="icon" href="{{ $general->site_icon ?? "Laravel"}}" type="image/x-icon"/>
    <link rel="shortcut icon" type="image/x-icon" href="{{$general->site_icon ?? "Laravel"}}"/>
...
{{--                                            <img class="img-radius" src="{{asset('assets/images/avatar-4.jpg')}}" alt="Generic placeholder image">--}}
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="media-body">
                                                <span class="notification-view float-right badge-inverse-warning p-10"><a href="#">Tümünü Görüntüle</a></span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
            ...
            <div class="main-friend-chat">
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="{{asset('assets/images/avatar-2.jpg')}}" alt="Generic placeholder image">
                    </a>

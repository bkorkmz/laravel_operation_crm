                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr style="border-collapse:collapse;">
                                                <td width="560" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:15px;"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#333333;">Hoş Geldiniz </h2></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left" style="padding:0;Margin:0;padding-top:20px;">
                                                                <span class="text-center">Sayın <strong>{{ $user['email']}}</strong><br>
                                                                    @if(auth()->check())
                                                                    Sitemize giriş yaparak sonuçlarını detaylı olarak görüntüleyebilirsiniz.
                                                                    @else
                                                                    Sİtemize hoş geldiniz. Aşağıda çözmüş olduğunuz test sonuçları gösterilmektedir.
                                                                    Sisteme kayıt olduğunuzda detaylı olarak sonuçlarınızı görebilirsiniz
                                                                    @endif
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td><b>Test  adı  </b></td>
                                                                        <td>:</td>
                                                                        <td><b>{{ $user['test_name'] }}</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Test Sonucu  </b></td>
                                                                        <td>:</td>
                                                                        <td><b>{{ "Doğru Sayısı :". $user['true']." / Yanlış Sayısı : ". $user['false'] }}</b></td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td><b>İşlem tarihi </b></td>
                                                                        <td>:</td>
                                                                        <td><b>{{ $user['create_date'] }}</b></td>
                                                                    </tr>
                                                                ...
                                                                <table width="75%" height="100%" cellspacing="0" cellpadding="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                                    <tr style="border-collapse:collapse;">
                                                                        <td style="padding:0;Margin:0px 0px 0px 0px;border-bottom:1px solid #CCCCCC;background:none;height:1px;width:100%;margin:0px;">
                                                                            İletişim : <a href="{{route('frontend.index')}}/#contact"> Mesaj bırakın</a><br>
                                                                            Eposta   : <a href="mailto:{{config('settings.site_email')}}">{{config('settings.site_email')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:11px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:17px;color:#333333;">
                                                                    <a href="{{route('frontend.index')}}"> Altınsoy Gümrük&nbsp;</a> ©
                                                                    {{date('Y')}} | Tüm hakları  saklıdır.</p>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>

        ...
        <div class="card-block">
            ...
            <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-normal" value="{{ route('frontend.post_detail', ['id' => $post->id, 'slug' => $post->slug]) }}" readonly>
                    </div>
                    <div class="col-sm-1" >
                        <a class="btn btn-success btn-sm"  href="{{ route('frontend.post_detail', ['id' => $post->id, 'slug' => $post->slug]) }}" target="_blank">Tıkla Git</a>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">İlan başlığı<span class="text-danger"> *</span></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" name="title" value="{{ $post->title }}" maxlength="500" minlength="5" required>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Okul - İşyeri Adı<span class="text-danger"> *</span></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" name="school_name" value="{{ $post->school_name }}" minlength="5" maxlength="500" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">İlan Açıklaması<span class="text-danger"> *</span></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" maxlength="255" name="keywords" value="{{ $post->keywords }}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" maxlength="255" minlength="5" name="address" value="{{ $post->address }}">
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Meslek Kategorisi<span class="text-danger"> *</span></label>
                    <div class="col-sm-3">
...
{{--                {{ dd($post->staj_start) }}--}}
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="date" name="staj_start" class="form-control " value="{{ $post->staj_start }}">
                    </div>

                    <div class="col-sm-3">
                        <input type="date" name="staj_finish" class="form-control " value="{{ $post->staj_finish }}">
                    </div>
                </div>
                ...
                <div class="form-group row clearfix">
                    ...
                    <div class="col-sm-3">
                        <select name="staj_donem" class="form-control fill" required>
                            ...
                            <option value="1" {{  $post->staj_donem == 1 ? 'selected' : '' }}>Yaz Dönemi (Haziran-Temmuz-Ağustos)</option>
                            <option value="2" {{  $post->staj_donem == 2 ? 'selected' : '' }} >Kış Dönemi  (Aralık-Ocak-Şubat)</option>
                            <option value="3" {{  $post->staj_donem == 3 ? 'selected' : '' }}>Diğer</option>
                        </select>
                    </div>

                                ...
                                <div class="card-block">
                                    ...
                                    <form action="{{ route('post.update',['post'=>$post->id]) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="ckeditor" name="detail" rows="5">{!! $post->detail !!}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control form-control-normal"
                                                    placeholder="" name="keywords" maxlength="50" value="{{$post->keywords}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row my-4">
                                            ...
                                            <div class="col-sm-3 float-center">
                                                ...
                                                <div class="form-check text-left">
                                                    <input class="form-check-input" {{$post->mtitle == 0 ? 'checked' : ""}} type="radio" name="mtitle"
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="publish"{{$post->publish == 1 ?: 'checked'}}
                                                        id="hideMtitle" value="1">
                                                    ...
                                                    <select name="photogallery_id" class="form-control fill">
                                                        ...
                                                        @if (!empty($photogalleries))
                                                            @foreach ($photogalleries as $photogallery)
                                                                <option {{$post->photogallery_id == $photogallery->id ? 'selected': ""}} value="{{ $photogallery->id }}">
                                                    ...
                                                    <select name="videogallery_id" class="form-control fill">
                                                        ...
                                                        @if (!empty($photogalleries))
                                                            @foreach ($videogalleries as $videogallery)
                                                                <option {{$post->videogallery_id == $videogallery->id ?'selected' :""}} value="{{ $videogallery->id }}">
                                                                    {{ $videogallery->title }}
                                                                </option>
                                                            @endforeach
                                                        @endif
                                        ...
                                        <div class="form-group has-warning row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control form-control-warning"
                                                    id="meta1" name="meta_keywords" value="{{$post->meta_keywords}}" maxlength="80">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" class="form-control form-control-normal dropify"
                                                data-show-remove="false"
                                                data-default-file="{{ $post->image_top  }}"
                                                accept=".jpg,.jpeg,.png,.tiff,.gif,.svg,.webp,.bmp,.ico"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" class="form-control form-control-normal dropify"
                                                data-show-remove="false"
                                                data-default-file="{{ $post->image_mini  }}"
                                                accept=".jpg,.jpeg,.png,.tiff,.gif,.svg,.webp,.bmp,.ico"

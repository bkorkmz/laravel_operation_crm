        ...
        <div class="card-block">
            ...
            <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" name="title" maxlength="500" minlength="5" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" name="school_name" maxlength="500" minlength="5">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">ilan Açıklaması<span class="text-danger"> *</span></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" maxlength="255" placeholder="" name="keywords">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Başvuru Adresi </label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-normal" placeholder="" maxlength="255" minlength="5" name="address">
                    </div>
                </div>
...
{{--                     <div class="col-sm-5" id="sub_category_select" hidden>--}}
{{--                        <select id="sub_category" name="sub_category" class="form-control fill " required>--}}
{{--                            <option value="">--Bir seçim yapınız--</option>--}}
{{--                        </select>--}}
{{--                    </div>--}}
...
{{--                    <label class="col-sm-2 col-form-label" for="location"> İlan Gösterimi </label>--}}
{{--                        <div class="col-sm-2">--}}
...
{{--                            <option value="2">Planlı Yayınla</option>--}}
                        </select>
                    </div>
                    <div class="col-sm-3">

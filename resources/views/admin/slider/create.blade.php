            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="{{ route($module_name.'.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row my-4">
                                    ...
                                    <div class="card-body">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" checked
                                                       name="banner_image"  {{ old('banner_image',0) == 0 ? 'checked' : '' }}
                            ...
                            <div class="card slider_type mr-2">
                                <label for="flexRadioDefault2">
                                    <div class="card-body">
                                        <div class="form-check">
                                            <input class="form-check-input" {{ old('banner_image',0) == 1 ? 'checked' : '' }}
                            ...
                            <div class="card slider_type mr-2">
                                <label for="flexRadioDefault3">
                                    <div class="card-body">
                                        <div class="form-check">
                                            <input class="form-check-input" {{ old('banner_image',0) == 2 ? 'checked' : '' }}
                                                   type="radio" name="banner_image"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">İçerik Resmi <span class="text-danger"> *</span></label>
                            <div class="col-sm-5">
                                <input type="file" class="form-control form-control-normal dropify" placeholder=""
                                    name="image" accept=".png,.jpg,.jpeg,.gif,.webp,.bmp" required>
                            </div>
                        </div>

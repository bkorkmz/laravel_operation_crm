        ...
        <div class="card-block">
            ...
            <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="number" class="form-control  fill" max="9999"  min="0"  name="stock">
                    </div>
                </div>  
                <div class="form-group row">
                ...
                <div class="text-right m-t-20">
                    <button class="btn btn-success rounded" onclick="return $('#is_next').val('1')" >Kaydet ve Yeni Ürün Ekle</button>

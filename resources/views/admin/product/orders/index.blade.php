                        ...
                        render: function (d) {
                            ...
                            <div class="tabledit-toolbar btn-toolbar " style="text-align: left;">
                                <div class="btn-group btn-group-sm d-flex" style="float: none;">
                                    <button data-id="${d.category_id}" type="button" class="disabled ml-1 mr-1 tabledit-edit-button btn btn-primary waves-effect waves-light" >
                                    ...
                                    <button data-id="${d.category_id}"  type="button" onclick="confirmDelete(${d.category_id})"
                                        class="ml-1 mr-1 tabledit-delete-button btn btn-danger waves-effect waves-light disabled" >

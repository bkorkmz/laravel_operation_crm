    ...
    @php
        $total_article    = $contents['total_article'];
        $total_product   = $contents['total_product'];
        $last_article    = $contents['last_article'];
        $total_services    = $contents['total_services'];
        $last_services    = $contents['last_services'];
        $user_count    = $contents['user_count'];
        $infoMessages    = $contents['infoMessages'];
        $mesageCount    = $contents['mesageCount'];
        $requestForm    = $contents['requestForm'];
        $newsletter    = $contents['newsletter'];
        $newsletterCount    = $contents['newsletterCount'];
                                ...
                                <div class="card comp-card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h6 class="m-b-25">Toplam Ürün </h6>
                                                <h3 class="f-w-700 text-c-green">{{$total_product}}</h3>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card comp-card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h6 class="m-b-25">Test Sonuçları</h6>
                                                <h3 class="f-w-700 text-c-orenge">{{$contents['testsCount']}}</h3>
                                                <p class="m-b-0">{{date('d.m.Y')}}</p>
                                            </div>

                                            <div class="col-auto card_area_icon">
                                                <i class="fas fa-edit bg-c-orenge"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card comp-card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h6 class="m-b-25"><a class="badge badge-lg badge-primary"
                                                                      href="{{route('newsletter_download')}}">Mail
                                                        Listesini indir </a></h6>
                                                <h3 class="f-w-700 text-c-green">{{$newsletterCount}}</h3>
                                                <p class="m-b-0">Güncellenme
                                                    : {{$newsletterCount > 0 ? $newsletter[0]->created_at->format('d.m.y. H:i') : date('d.m.Y H:i')}}</p>
                                            </div>
                                            <div class="col-auto card_area_icon">
                                        ...
                                        @foreach ($infoMessages as $message )
                                            <div class="row p-b-30">
                                                ...
                                                <div class="col p-l-5">
                                                    ...
                                                    <p class="text-muted m-b-0">{{$message->title}}
                                                        - {{$message->email}}</p>
                                                </div>
                                            </div>
                                        @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($r_form->publish == 0)
                                                            <label id="read_{{$r_form->id }}"
                                                                   class="badge badge-danger">Bekliyor</label>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <button type="button"

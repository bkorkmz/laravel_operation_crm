...
@section('content')
        ...
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <a href="#about"
                       class="{{config('settings.landing_slider_button_title') == "" ?"d-none" :""}}btn-get-started scrollto">{{config('settings.landing_slider_button_title')}}</a>
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        @include('theme1.frontend.pages.slider')
        <!-- End Clients Section -->
        <!-- ======= About Section ======= -->


        @include('theme1.frontend.pages.about_us',['data' =>$about_page])
        <!-- End About Section -->
        ...
        <!-- ======= Tabs Section ======= -->
        @include('theme1.frontend.pages.article',['data' =>$article])
        <!-- End Tabs Section -->

        <!-- ======= Services Section ======= -->
        @include('theme1.frontend.pages.services')
        <!-- End Services Section -->

        <!-- ======= Portfolio Section ======= -->
        @include('theme1.frontend.pages.portfolio',['data'=>$portfolio])
                            ...
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    ...
                                    <p>
                                        ...
                                        veniam enim
                                        culpa labore duis sunt culpa nulla illum cillum fugiat esse veniam culpa fore nisi
                                        cillum quid.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
        ...
        @include('theme1.frontend.pages.sss',['data'=>$faq_sss])
        <!-- End Frequently Asked Questions Section -->

        <!-- ======= Team Section ======= -->
        <!-- TODO:kaldırılacak -->

        @include('theme1.frontend.pages.teams')
        <!-- End Team Section -->

        <!-- ======= Contact Section ======= -->
        @include('theme1.frontend.pages.contact')
        <!-- End Contact Section -->

    ...
    <div class="container" data-aos="fade-up">
      ...
      <ul class="nav nav-tabs row d-flex">
        @php
            $icons=[
                ...
                "ri-body-scan-line",
                "ri-sun-line",
                "ri-store-line","ri-wireless-charging-fill","ri-24-hours-line","ri-align-right"
            ]
        @endphp
        @foreach ($article as $data )
        <li class="nav-item col-3">
            <a class="nav-link {{$loop->iteration == 1 ? "active show" : ""}} rounded-3" data-bs-toggle="tab" data-bs-target="#tab-{{$loop->iteration}}">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane {{$loop->iteration == 1 ? "active show" : ""}}" id="tab-{{$loop->iteration}}">
          <div class="row">
            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0" data-aos="fade-up" data-aos-delay="100" style="max-height: 200px">
              <h3>{!! $data->title !!}</h3>
              <p class="fst-italic">
               {!! $data->short_detail !!}
              </p>

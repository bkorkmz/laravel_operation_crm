...
//        Artisan::call($parameter, [], new StreamOutput($stream));
//
...
Route::prefix('backend')->middleware('auth','company')->group(function () {
    ...
    Route::controller(CategoryController::class)->prefix('category')->group(function () {
        ...
        Route::post('/edit', 'update')->name($module_name.'.update')->middleware('permission:edit_category');
        ...
        Route::get('/all-category-data', 'categoryData')->name($module_name.'.categoryData');
